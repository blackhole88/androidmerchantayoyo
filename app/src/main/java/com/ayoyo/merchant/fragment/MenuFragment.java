...
import com.ayoyo.merchant.item.CategoryItem;
import com.ayoyo.merchant.item.CategoryNonItem;
...
import com.ayoyo.merchant.models.KategoriItemModel;
import com.ayoyo.merchant.models.KategoriItemNonModel;
            ...
            public void onResponse(Call<KategoriResponseJson> call, Response<KategoriResponseJson> response) {
                if (response.isSuccessful()) {
                    if (Objects.requireNonNull(response.body()).getMessage().equalsIgnoreCase("success")) {
                        ...
                        itemada.setText(response.body().getTotalitemactive() + " Barang Tersedia");
                        itemhabis.setText(response.body().getTotalitemnonactive() + " Barang Kehabisan Stok");
                        itempromo.setText(response.body().getTotalitempromo() + " Barang Promo");
