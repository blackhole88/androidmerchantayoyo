...
import com.ayoyo.merchant.item.MenusItem;
...
import com.ayoyo.merchant.models.ItemModel;
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (text.getText().toString().isEmpty()) {
                    Toast.makeText(MenuActivity.this, "Harap masukkan nama kategori!", Toast.LENGTH_SHORT).show();
                } else {
                    submit.setEnabled(false);
                    submit.setText(R.string.waiting_pleaseWait);
                        ...
                        public void onResponse(Call<ResponseJson> call, Response<ResponseJson> response) {
                            if (response.isSuccessful()) {
                                if (Objects.requireNonNull(response.body()).getMessage().equalsIgnoreCase("success")) {
                                    ...
                                    Toast.makeText(MenuActivity.this, R.string.success, Toast.LENGTH_SHORT).show();
                                    dialog.dismiss();

                                } else {
                                    submit.setEnabled(true);
                                    Toast.makeText(MenuActivity.this, "Error!", Toast.LENGTH_SHORT).show();
                                    submit.setText(R.string.edit_category);
