...
import com.ayoyo.merchant.item.MenuItem;
import com.ayoyo.merchant.json.DetailRequestJson;
import com.ayoyo.merchant.json.DetailTransResponseJson;
import com.ayoyo.merchant.models.DriverModel;
import com.ayoyo.merchant.models.PelangganModel;
import com.ayoyo.merchant.models.TransaksiModel;
                ...
                if (response.isSuccessful()) {
                    if (Objects.requireNonNull(response.body()).getMessage().equalsIgnoreCase("success")) {
                        ...
                        if (transaksi.isPakaiWallet()) {
                            metodepembayaran.setText("Total Harga (Wallet)");
                        } else {
                            metodepembayaran.setText("Total Harga (Cash)");
                        }
